...
export namespace FundWidthdrawEvent {
...
export interface DonationPlatform extends BaseContract {
  ...
  collectFunds: TypedContractMethod<
    [amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getEvent(
    ...
    FundWidthdrawEvent.InputTuple,
    FundWidthdrawEvent.OutputTuple,
    FundWidthdrawEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "FundWidthdraw(address,uint256)": TypedContractEvent<
      FundWidthdrawEvent.InputTuple,
      FundWidthdrawEvent.OutputTuple,
      FundWidthdrawEvent.OutputObject
    >;
    FundWidthdraw: TypedContractEvent<
      FundWidthdrawEvent.InputTuple,
      FundWidthdrawEvent.OutputTuple,
      FundWidthdrawEvent.OutputObject
    >;
